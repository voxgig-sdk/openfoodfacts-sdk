// Command Openfoodfacts-mcp is an MCP server exposing the Openfoodfacts
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Openfoodfacts_list  — list records of an entity
//	Openfoodfacts_load  — load a single record of an entity
//
