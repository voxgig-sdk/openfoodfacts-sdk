...
type Args struct {
	Entity string         `json:"entity" jsonschema:"product"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.OpenfoodfactsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "openfoodfacts_list",
		Description: "List records from Openfoodfacts. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "openfoodfacts_load",
		Description: "Load a single record from Openfoodfacts. " +
...
func runOp(client *sdk.OpenfoodfactsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.OpenfoodfactsSDK, name string) (sdk.OpenfoodfactsEntity, error) {
