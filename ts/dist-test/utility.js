...
function envOverride(m) {
    if ('TRUE' === process.env.OPENFOODFACTS_TEST_LIVE ||
        'TRUE' === process.env.OPENFOODFACTS_TEST_OVERRIDE) {
    ...
    m.OPENFOODFACTS_TEST_EXPLAIN = process.env.OPENFOODFACTS_TEST_EXPLAIN || m.OPENFOODFACTS_TEST_EXPLAIN;
    return m;
}
