...
(0, node_test_1.describe)('ProductDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.OpenfoodfactsSDK({
...
function liveScenariosActive() { return false && process.env.OPENFOODFACTS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.OpenfoodfactsSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.OPENFOODFACTS_APIKEY,
        }));
        let idmap = env['OPENFOODFACTS_TEST_PRODUCT_ENTID'];
    ...
    const client = new __1.OpenfoodfactsSDK({
        base: 'http://localhost:8080',
