# Openfoodfacts TypeScript SDK

The TypeScript SDK for the Openfoodfacts API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new OpenfoodfactsSDK({ apikey: '...' })
...
| Method | Returns | Description |
| --- | --- | --- |
| `OpenfoodfactsSDK.test(testopts?, sdkopts?)` | `OpenfoodfactsSDK` | Create a test-mode client. |
...
openfoodfacts/
├── src/
│   ├── OpenfoodfactsSDK.ts        # Main SDK class
