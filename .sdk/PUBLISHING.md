...
|---|---|---|
| `ts/` | @voxgig-sdk/openfoodfacts-sdk | `.github/workflows/publish-ts.yml` |
...
`ts` target it runs:
    ...
    npm trust github @voxgig-sdk/openfoodfacts-sdk \
      --repository voxgig-sdk/openfoodfacts-sdk \
      --file publish-ts.yml \
      --allow-publish
...
`npm trust list @voxgig-sdk/openfoodfacts-sdk` shows the configuration, and
`npm trust revoke @voxgig-sdk/openfoodfacts-sdk --id=<id>` removes one.
