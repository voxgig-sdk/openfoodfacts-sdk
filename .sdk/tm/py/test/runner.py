...
class OpenfoodfactsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = OpenfoodfactsTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = OpenfoodfactsTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = OpenfoodfactsTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
