...
class OpenfoodfactsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = OpenfoodfactsTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = OpenfoodfactsTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = OpenfoodfactsTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
