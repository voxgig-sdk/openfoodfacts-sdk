...
// Openfoodfacts SDK clienttrack feature
...
class OpenfoodfactsClienttrackFeature extends OpenfoodfactsBaseFeature
{
    ...
    public function PostConstruct(OpenfoodfactsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Openfoodfacts-SDK';
