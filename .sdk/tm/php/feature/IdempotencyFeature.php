...
// Openfoodfacts SDK idempotency feature
...
class OpenfoodfactsIdempotencyFeature extends OpenfoodfactsBaseFeature
{
    ...
    private function _mutating(OpenfoodfactsContext $ctx): bool
    {
