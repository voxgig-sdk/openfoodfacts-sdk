...
// Openfoodfacts SDK timeout feature
...
class OpenfoodfactsTimeoutFeature extends OpenfoodfactsBaseFeature
{
    ...
    private function _with_timeout(OpenfoodfactsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(OpenfoodfactsContext $_ctx, float $ms): void
    {
        $client = $this->client;
