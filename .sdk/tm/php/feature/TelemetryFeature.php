...
// Openfoodfacts SDK telemetry feature
...
class OpenfoodfactsTelemetryFeature extends OpenfoodfactsBaseFeature
{
    ...
    private function _close(OpenfoodfactsContext $ctx, bool $ok): void
    {
