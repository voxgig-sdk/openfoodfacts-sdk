...
// Openfoodfacts SDK streaming feature
...
class OpenfoodfactsStreamingFeature extends OpenfoodfactsBaseFeature
{
    ...
    private function _iterate(OpenfoodfactsResult $result): \Generator
    {
    ...
    private function _streamable(OpenfoodfactsContext $ctx): bool
    {
