...
// Openfoodfacts SDK cache feature
...
class OpenfoodfactsCacheFeature extends OpenfoodfactsBaseFeature
{
    ...
    private function _through(OpenfoodfactsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
