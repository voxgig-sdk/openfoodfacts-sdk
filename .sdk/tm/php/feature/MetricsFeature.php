...
// Openfoodfacts SDK metrics feature
...
class OpenfoodfactsMetricsFeature extends OpenfoodfactsBaseFeature
{
    ...
    private function _record(OpenfoodfactsContext $ctx, bool $ok): void
    {
