...
// Openfoodfacts SDK utility: graphql
//
...
class OpenfoodfactsGraphql
{
    ...
    // equivalent.
    public static function body(OpenfoodfactsContext $ctx): mixed
    {
    ...
    public static function errors(OpenfoodfactsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
