...
// Openfoodfacts SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class OpenfoodfactsMakeRequest
{
    public static function call(OpenfoodfactsContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new OpenfoodfactsResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new OpenfoodfactsResponse($fetched);
        } else {
