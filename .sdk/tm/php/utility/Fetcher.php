...
class OpenfoodfactsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; OpenfoodfactsSDK/1.0)';
    ...
    public static function call(OpenfoodfactsContext $ctx, string $fullurl, array $fetchdef): array
    {
