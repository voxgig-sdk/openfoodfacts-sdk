...
// Openfoodfacts SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class OpenfoodfactsTransformResponse
{
    public static function call(OpenfoodfactsContext $ctx): mixed
    {
        ...
        $transform = OpenfoodfactsHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
