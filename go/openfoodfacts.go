...
// instead of `sdk.NewOpenfoodfactsSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *OpenfoodfactsSDK  { return NewOpenfoodfactsSDK(nil) }
func Test() *OpenfoodfactsSDK { return TestSDK(nil, nil) }
