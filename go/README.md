...
The Golang SDK for the Openfoodfacts API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/openfoodfacts-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/openfoodfacts-sdk=../path/to/github.com/voxgig-sdk/openfoodfacts-sdk
```
...
```
github.com/voxgig-sdk/openfoodfacts-sdk/
...
The root package (`github.com/voxgig-sdk/openfoodfacts-sdk`) re-exports everything needed
