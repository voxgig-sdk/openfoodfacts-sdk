...
func (sdk *OpenfoodfactsSDK) OptionsMap() map[string]any {
...
func (sdk *OpenfoodfactsSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *OpenfoodfactsSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *OpenfoodfactsSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *OpenfoodfactsSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *OpenfoodfactsSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *OpenfoodfactsSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("OpenfoodfactsSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *OpenfoodfactsSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *OpenfoodfactsSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("OpenfoodfactsSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *OpenfoodfactsSDK {
	...
	sdk := NewOpenfoodfactsSDK(sdkopts)
	sdk.Mode = "test"
