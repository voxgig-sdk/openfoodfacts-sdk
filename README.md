...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/openfoodfacts` | `npm install @voxgig-sdk/openfoodfacts` |
| Python | `voxgig-sdk-openfoodfacts` | `pip install voxgig-sdk-openfoodfacts` |
| PHP | `voxgig-sdk/openfoodfacts` | `composer require voxgig-sdk/openfoodfacts` |
| Golang | `github.com/voxgig-sdk/openfoodfacts-sdk/go` | `go get github.com/voxgig-sdk/openfoodfacts-sdk/go` |
| Ruby | `voxgig-sdk-openfoodfacts` | `gem install voxgig-sdk-openfoodfacts` |
| Lua | `voxgig-sdk-openfoodfacts` | `luarocks install voxgig-sdk-openfoodfacts` |
