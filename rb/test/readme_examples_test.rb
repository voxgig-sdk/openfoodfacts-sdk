...
#      offline in seeded test mode (OpenfoodfactsSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "Openfoodfacts_sdk.rb")
  SDK_CLASS = "OpenfoodfactsSDK"
