...
module OpenfoodfactsTestRunner
  @env = {}
  ...
  def self.env_override(m)
    live = getenv("OPENFOODFACTS_TEST_LIVE")
    override = getenv("OPENFOODFACTS_TEST_OVERRIDE")
    ...
    explain = getenv("OPENFOODFACTS_TEST_EXPLAIN")
    m["OPENFOODFACTS_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = OpenfoodfactsTestRunner
Helpers = OpenfoodfactsHelpers
Vs = VoxgigStruct
