...
func registerSDKWords(r *eng.Registry, client *sdk.OpenfoodfactsSDK) {
...
func runOp(client *sdk.OpenfoodfactsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
