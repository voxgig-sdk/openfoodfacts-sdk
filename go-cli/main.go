// Command Openfoodfacts-cli is a CLI + REPL for the Openfoodfacts SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      OPENFOODFACTS_APIKEY (api key), OPENFOODFACTS_BASE (base url override)")
