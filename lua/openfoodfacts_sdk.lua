...
local OpenfoodfactsSDK = {}
OpenfoodfactsSDK.__index = OpenfoodfactsSDK
...
OpenfoodfactsSDK._make_feature = _make_feature


function OpenfoodfactsSDK.new(options)
  local self = setmetatable({}, OpenfoodfactsSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function OpenfoodfactsSDK:options_map()
...
function OpenfoodfactsSDK:get_utility()
  return Utility.copy(self._utility)
end


function OpenfoodfactsSDK:get_root_ctx()
  return self._rootctx
end


function OpenfoodfactsSDK:prepare(fetchargs)
...
function OpenfoodfactsSDK:direct(fetchargs)
...
-- by passing it.
function OpenfoodfactsSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function OpenfoodfactsSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "OpenfoodfactsSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function OpenfoodfactsSDK.test(testopts, sdkopts)
  ...
  local sdk = OpenfoodfactsSDK.new(sdkopts)
  sdk.mode = "test"
