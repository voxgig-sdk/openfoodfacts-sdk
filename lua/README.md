# Openfoodfacts Lua SDK



The Lua SDK for the Openfoodfacts API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/openfoodfacts-sdk/releases)),
...
| `image_url` | `string` |  |
| `ingredients_analysis_tags` | `table` |  |
...
```
lua/
├── openfoodfacts_sdk.lua    -- Main SDK module
...
The main module (`openfoodfacts_sdk`) exports the SDK constructor
