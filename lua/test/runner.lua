...
function runner.env_override(m)
  local live = runner.getenv("OPENFOODFACTS_TEST_LIVE")
  local override = runner.getenv("OPENFOODFACTS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("OPENFOODFACTS_TEST_EXPLAIN")
