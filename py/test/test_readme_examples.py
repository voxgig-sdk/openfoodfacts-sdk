# Openfoodfacts SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions OpenfoodfactsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both OpenfoodfactsSDK(...) and OpenfoodfactsSDK.test(...) become
#      OpenfoodfactsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "openfoodfacts_sdk"
_SDK_CLASS = "OpenfoodfactsSDK"
