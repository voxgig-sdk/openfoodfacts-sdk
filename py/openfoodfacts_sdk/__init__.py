...
from openfoodfacts_sdk.utility import register

# Load features
from openfoodfacts_sdk.feature.base_feature import OpenfoodfactsBaseFeature
from openfoodfacts_sdk.features import _has_feature, _make_feature
...
class OpenfoodfactsSDK:
    ...
    def get_utility(self):
        return OpenfoodfactsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("OpenfoodfactsSDK: graphql: " + str(msg))
            res["graphql"] = errors
