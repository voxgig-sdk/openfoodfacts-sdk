...
from openfoodfacts_sdk.core.control import OpenfoodfactsControl
...
from openfoodfacts_sdk.core.helpers import get_ctx_prop, to_map
...
class OpenfoodfactsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = OpenfoodfactsControl()
        ...
        if isinstance(sp, OpenfoodfactsSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, OpenfoodfactsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, OpenfoodfactsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return OpenfoodfactsError(code, msg, self)
