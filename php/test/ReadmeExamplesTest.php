...
// Openfoodfacts SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (OpenfoodfactsSDK::test)
...
{
    private const SDK_CLASS = 'OpenfoodfactsSDK';
    ...
    private const SDK_BASE = 'openfoodfacts_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../openfoodfacts_sdk.php';
