...
class OpenfoodfactsTestRunner
{
    ...
    {
        $live = self::getenv('OPENFOODFACTS_TEST_LIVE');
        $override = self::getenv('OPENFOODFACTS_TEST_OVERRIDE');
        ...
        $explain = self::getenv('OPENFOODFACTS_TEST_EXPLAIN');
...
class_alias('OpenfoodfactsTestRunner', 'Runner');
class_alias('OpenfoodfactsHelpers', 'Helpers');
