...
// Openfoodfacts SDK utility: make_options

class OpenfoodfactsMakeOptions
{
    ...
    public static function call(OpenfoodfactsContext $ctx): array
    {
        ...
        //
        // `OpenfoodfactsSchema::optspec()` is built from the model:
        ...
        $optspec = OpenfoodfactsSchema::optspec();
