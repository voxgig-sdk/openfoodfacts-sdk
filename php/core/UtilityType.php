...
// Openfoodfacts SDK utility type

class OpenfoodfactsUtility
{
    ...
    public static function copy(OpenfoodfactsUtility $src): OpenfoodfactsUtility
    {
        $u = new OpenfoodfactsUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
