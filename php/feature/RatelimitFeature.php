...
// Openfoodfacts SDK ratelimit feature
...
class OpenfoodfactsRatelimitFeature extends OpenfoodfactsBaseFeature
{
    ...
    private function _acquire(OpenfoodfactsContext $ctx): void
    {
    ...
    private function _track(OpenfoodfactsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
