...
// Openfoodfacts SDK audit feature
...
class OpenfoodfactsAuditFeature extends OpenfoodfactsBaseFeature
{
    ...
    private function _emit(OpenfoodfactsContext $ctx, string $outcome): void
    {
