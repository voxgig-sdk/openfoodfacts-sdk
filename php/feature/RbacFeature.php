...
// Openfoodfacts SDK rbac feature
...
class OpenfoodfactsRbacFeature extends OpenfoodfactsBaseFeature
{
    ...
    private function _required(OpenfoodfactsContext $ctx): ?string
    {
    ...
    private function _reject(OpenfoodfactsContext $ctx, string $required): void
    {
    ...
    private function _track(OpenfoodfactsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
