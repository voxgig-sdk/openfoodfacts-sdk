...
// Openfoodfacts SDK proxy feature
...
class OpenfoodfactsProxyFeature extends OpenfoodfactsBaseFeature
{
    ...
    public function init(OpenfoodfactsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (OpenfoodfactsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
