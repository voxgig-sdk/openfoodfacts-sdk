...
// Openfoodfacts SDK netsim feature
...
class OpenfoodfactsNetsimFeature extends OpenfoodfactsBaseFeature
{
    ...
    private function _simulate(OpenfoodfactsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(OpenfoodfactsContext $ctx, array $applied): void
    {
        $client = $this->client;
