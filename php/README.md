# Openfoodfacts PHP SDK

The PHP SDK for the Openfoodfacts API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Product(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->Openfoodfacts(null)->load(
    ["id" => "test01"], null
);
...
```
php/
├── openfoodfacts_sdk.php          -- Main SDK class
...
The main class (`openfoodfacts_sdk.php`) exports the SDK class
